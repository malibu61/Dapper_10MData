...
namespace _Kurs_10_Dapper.ViewComponents
{
    public class _BrandPreferredInfoComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var top10Brand = string.Join(", ", values.Select(s => $"{s.BRAND}: {s.PreferredCount}"));
            ...
            var requestBody = new
            {
                ...
                new { role = "user", content = "Bununla alakalı analiz yap ve iyileştirme için fikir ver.Cevabı Türkçe ver (maks 500 karakter)(Tercih edilen Top 10 Marka):"+top10Brand },
            },
